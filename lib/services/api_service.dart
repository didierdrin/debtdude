...
class ApiService {
  static const String baseUrl = 'https://debtdude-expressjs-backend.onrender.com/api'; 
  ...
  // Send message with Firebase transaction data
  ...
  Future<Map<String, dynamic>> getAnalysis(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {'success': false, 'error': 'Failed to analyze transactions'};
      }
    } catch (e) {
      return {'success': false, 'error': 'Network error: $e'};
    }
